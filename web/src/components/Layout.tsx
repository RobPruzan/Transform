        ...
        <body className="blueBody">
          <div className="center-full">
            <div className="blue">
              ...
              <img
                src="https://i.ibb.co/dP8wTR4/image-22.png"
                className="brain"
              ></img>
          ...
          <section className="container2">
            <div className="class_card">
              ...
              <a href="">
                <img src="https://i.postimg.cc/Bnv2SBfP/image-7.png" alt="" />
              </a>
            </div>
            <div className="class_card">
              <h2 className="class_name"> Finance </h2>
              <a href="">
                <img src="https://i.postimg.cc/DyhwPvC2/image-6.png" alt="" />
              </a>
            </div>
            <div className="class_card">
              <h2 className="class_name"> Programming </h2>
              <a href="">
                <img src="https://i.postimg.cc/yYfC3stp/image-8.png" alt="" />
              </a>
            </div>
          </section>
        </body>
